...
public class DbTest {
    ...
    public void fun01() throws Exception {
        ...
        //2. 根据id获得对象
        AccountService accountService01 = (AccountService) applicationContext.getBean("accountService07");
        AccountService accountService02 = (AccountService) applicationContext.getBean("accountService07");
